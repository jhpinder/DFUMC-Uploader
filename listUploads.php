  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-light border-bottom mb-3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a class="nav-link active" href="/">Hymn Uploader</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">Basic Viewer<span class="sr-only">(current)</span></a>
        </li>
      </ul>
    </div>
  </nav>
...
*/
echo '<div class="container bg-light-1 rounded-lg py-2 px-3 my-2"><h1 class="display-5">Upload Viewer</h1><hr class="my-4"><div id="listDiv">';
